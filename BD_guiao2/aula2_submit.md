...
```
Produto(codigo, nome, preco, taxa_de_IVA, quantidade_em_armazem)
Encomenda(numero_de_encomenda, data_de_realizacao, fornecedor)
Fornecedor(nome, NIF, endereco, fax, condicoes_pagamento, codigo)
```
...
```
Relação Empresa-Produto: Grau 2; Cardinalidade 1/N; Com obrigatoriedade
Relação Produto-Encomenda: Grau 2; Cardinalidade N/N; Encomenda é uma       entidade fraca, sem obrigatoriedade
Relação Encomenda-Fornecedor: Grau 2; Cardinalidade N/1; Encomenda é uma entidade fraca, sem obrigatoriedade
```
